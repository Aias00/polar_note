  ...
  for (var e = t.split("&"), n = {}, o = {}, r = 0; r < e.length; ++r) {
    ...
    "[]" != a.substring(a.length - 2, a.length)
      ...
      : ((a = a.substring(0, a.length - 2)),
        void 0 == o[a] ? (o[a] = [s]) : o[a].push(s));
  }
  return $.extend(n, o);
}
function _ajaxCallback(t, e, n) {
  if (t === !0 || "true" == t || "object" == typeof t) {
    if (t && "object" == typeof t && "NOTLOGIN" == t.Msg)
      return void alert(getMsg("Please sign in firstly!"));
    "function" == typeof e && e(t);
  } else "function" == typeof n ? n(t) : alert("error!");
}
function _ajax(t, e, n, o, r, i) {
  return (
    (i = "undefined" == typeof i ? !0 : !1),
    $.ajax({
      type: t,
      url: e,
      data: n,
...
function findParents(t, e) {
  if ($(t).is(e)) return $(t);
  for (var n = $(t).parents(), o = 0; o < n.length; ++o)
    if ((log(n.eq(o)), n.eq(o).is(e))) return n.seq(o);
  return null;
}
...
function setEditorContent(t, e, n, o) {
  if (
    (t || (t = ""),
    clearIntervalForSetContent && clearInterval(clearIntervalForSetContent),
    e)
  )
    MD
      ? (MD.setContent(t), MD.clearUndo && MD.clearUndo(), o && o())
...
function isAceError(t) {
  return t
    ? -1 != t.indexOf("XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX")
    : !1;
}
...
function _getEditorContent(t) {
  if (t)
    return [
      MD.getContent(),
      "<div>" + $("#preview-contents").html() + "</div>"
    ];
  var e = tinymce.activeEditor;
  if (e) {
    var n = $(e.getBody()).clone();
    if ((n.find(".toggle-raw").remove(), window.LeaAce && LeaAce.getAce))
      for (var o = n.find("pre"), r = 0; r < o.length; ++r) {
        var i = o.eq(r),
          a = i.attr("id"),
          s = LeaAce.getAce(a);
        if (s) {
          ...
          isAceError(l) && (l = i.html()),
            ...
            i
              ...
              .removeClass("ace_editor"),
            i.html(l);
        }
      }
    if (
      (n.find("pinit").remove(),
      n.find(".thunderpin").remove(),
      n
        .find(".pin")
        .parent()
        .remove(),
...
function showDialogRemote(t, e) {
  ...
  $("#leanoteDialogRemote").modal({ remote: t });
}
...
function notifyInfo(t) {
  $.pnotify({ title: "通知", text: t, type: "info", styling: "bootstrap" });
}
function notifyError(t) {
  ($.pnotify.defaults.delay = 2e3),
    $.pnotify({ title: "通知", text: t, type: "error", styling: "bootstrap" });
}
function notifySuccess(t) {
  $.pnotify({ title: "通知", text: t, type: "success", styling: "bootstrap" });
}
...
function getImageSize(t, e) {
  function n(t, n) {
    o.parentNode.removeChild(o), e({ width: t, height: n });
  }
...
function saveBookmark() {
  try {
    if (
      ((LEA.bookmark = tinymce.activeEditor.selection.getBookmark()),
      LEA.bookmark && LEA.bookmark.id)
    ) {
      ...
      if (n.is("span")) {
        var o = n,
          r = o.eq(0);
        r.attr("id") == LEA.bookmark.id + "_start"
          ? ((LEA.hasBookmark = !1), r.remove())
          : (LEA.hasBookmark = !0);
      } else if (n.is("p")) {
        var o = n.children();
...
function getHashObject() {
  ...
  if (!t) return {};
  for (
    var e = t.substr(1), n = e.split("&"), o = {}, r = 0;
    r < n.length;
    ++r
  ) {
    var i = n[r].split("=");
...
$.extend(LEA, {
  ...
  off: function(t, e) {
    ...
    for (n = 0; n < a.length; n++)
      if ((r = this._eventCallbacks[a[n].toLowerCase()])) {
...
var vd = {
    ...
    init: function(form, rule_funcs) {
      ...
      function get_rules(target, name) {
        return (
          rules[name] || (rules[name] = eval("(" + target.data("rules") + ")")),
          rules[name]
        );
      }
      function get_msg_target(t, e) {
        if (!msg_targets[e]) {
          ...
          if (n) msg_targets[e] = $(n);
            ...
            var o = $(
              '<div class="help-block alert alert-warning" style="display: block;"></div>'
            );
...
(Note.curNoteId = ""),
  (Note.interval = ""),
  (Note.itemIsBlog =
    '<div class="item-blog"><i class="fa fa-bold" title="blog"></i></div><div class="item-setting"><i class="fa fa-cog" title="setting"></i></div>'),
  (Note.itemTplNoImg = '<li href="#" class="item ?" data-seq="?" noteId="?">'),
  (Note.itemTplNoImg +=
    Note.itemIsBlog +
    '<div class="item-desc"><p class="item-title">?</p><p class="item-info"><i class="fa fa-book"></i> <span class="note-notebook">?</span> <i class="fa fa-clock-o"></i> <span class="updated-time">?</span></p><p class="desc">?</p></div></li>'),
  (Note.itemTpl =
    '<li href="#" class="item ? item-image" data-seq="?" noteId="?"><div class="item-thumb" style=""><img src="?"/></div>'),
  (Note.itemTpl +=
    Note.itemIsBlog +
    '<div class="item-desc" style=""><p class="item-title">?</p><p class="item-info"><i class="fa fa-book"></i> <span class="note-notebook">?</span> <i class="fa fa-clock-o"></i> <span class="updated-time">?</span></p><p class="desc">?</p></div></li>'),
  (Note.newItemTpl =
    '<li href="#" class="item item-active ?" data-seq="?" fromUserId="?" noteId="?">'),
  (Note.newItemTpl +=
    Note.itemIsBlog +
    '<div class="item-desc" style="right: 0px;"><p class="item-title">?</p><p class="item-info"><i class="fa fa-book"></i> <span class="note-notebook">?</span> <i class="fa fa-clock-o"></i> <span class="updated-time">?</span></p><p class="desc">?</p></div></li>'),
  ...
  (Note.getNotesByNotebookId = function(t) {
    var e = Note.getSorterAndOrder(),
      o = e.sortBy,
      a = e.isAsc;
    if ((Note.listIsIn(), t || (t = "all"), !Note.cacheByNotebookId[t]))
      return [];
    if (Note.cacheByNotebookId[t][o]) {
      if (Note.cacheByNotebookId[t][o][a])
        return Note.cacheByNotebookId[t][o][a];
      Note.cacheByNotebookId[t][o][!a].reverse();
      var n = Note.cacheByNotebookId[t][o][!a];
      return (
        (Note.cacheByNotebookId[t][o][!a] = null),
  ...
  (Note.renderNotesAndFirstOneContent = function(t, e) {
    isArray(t) &&
      (Note.renderNotes(t, !1, !1, e),
      isEmpty(t[0]) || Note.changeNoteForPjax(t[0].NoteId, !0, !1));
  }),
  (Note.curHasChanged = function(t, e) {
    ...
    o.IsNew &&
      ((i.hasChanged = !0),
      (i.title = a),
      LEA.topInfo && (i.Src = LEA.topInfo.src)),
      o.Title != a && ((i.hasChanged = !0), (i.Title = a)),
      arrayEqual(o.Tags, n) || ((i.hasChanged = !0), (i.Tags = n.join(",")));
    var r = !1;
    if (((o.IsNew || t || !Note.readOnly) && (r = !0), !i.hasChanged && !r))
      return !1;
    if (!r) return i;
    var s,
      c,
      l = getEditorContent(o.IsMarkdown);
    if (
      (isArray(l)
        ? ((s = l[0]),
          (c = l[1]),
          s && previewIsEmpty(c) && Converter && (c = Converter.makeHtml(s)),
          s || (c = ""),
          (o.Preview = c))
        : (s = l),
      i.Src &&
    ...
    if (o.Content != s) {
      ...
      var d = c || s;
      (o.HasSelfDefined && o.IsBlog) ||
        ((i.Desc = Note.genDesc(d)),
        (i.ImgSrc = Note.getImgSrc(d)),
        (i.Abstract = Note.genAbstract(d)));
    } else log("text相同");
  ...
  (Note.curChangedSaveIt = function(t, e, o) {
    ...
    if (Note.curNoteId && !Note.isReadOnly) {
      ...
      return n && n.hasChanged
        ? (log("需要保存..."),
          Note.renderChangedNote(n),
          delete n.hasChanged,
          showMsg(getMsg("saving")),
          (a.saveInProcess[n.NoteId] = !0),
          ajaxPost("/note/updateNoteOrContent", n, function(t) {
            (a.saveInProcess[n.NoteId] = !1),
              n.IsNew &&
                ((t.IsNew = !1), Note.setNoteCache(t, !1), Pjax.changeNote(t)),
              e && e(),
              showMsg(getMsg("saveSuccess"), 1e3);
          }),
          void 0 != n.Tags &&
            "string" == typeof n.Tags &&
            (n.Tags = n.Tags.split(",")),
          Note.setNoteCache(n, !1),
          Note.setNoteCache(
            {
              NoteId: n.NoteId,
          ...
          Note.clearCacheByNotebookId(n.NotebookId),
          n)
        : (log("无需保存"), !1);
    }
  }),
  (Note.updatePoolNote = function() {
    var t = this;
    for (var e in t.savePool)
      if (e) {
        delete t.savePool[e];
        var o = t.savePool[e];
        (t.saveInProcess[e] = !0),
          ajaxPost("/note/updateNoteOrContent", o, function(o) {
            t.saveInProcess[e] = !1;
          });
      }
  }),
  ...
  (Note.changeNoteForPjax = function(t, e, o) {
    ...
    if (n) {
      ...
      void 0 == o && (o = !0),
        ...
        o &&
          (i
            ? $("#myShareNotebooks").hasClass("closed") &&
              $("#myShareNotebooks .folderHeader").trigger("click")
            : $("#myNotebooks").hasClass("closed") &&
              $("#myNotebooks .folderHeader").trigger("click"),
          Notebook.expandNotebookTo(n.NotebookId));
    }
  }),
  ...
  (Note.changeNote = function(t, e, o, a) {
    function n(e, o) {
      (Note.contentAjax = null),
        o == Note.contentAjaxSeq &&
          (Note.setNoteCache(e, !1),
          (e = Note.cache[t]),
    ...
    if (t) {
      ...
      if (s) {
        ...
        c
          ? (Note.hideReadOnly(), Note.renderNote(s))
          : Note.renderNoteReadOnly(s),
  ...
  (Note.renderChangedNote = function(t) {
    if (t) {
      ...
      t.Title && e.find(".item-title").html(trimTitle(t.Title)),
        ...
        t.ImgSrc
          ? (($thumb = e.find(".item-thumb")),
            $thumb.length > 0
              ? $thumb.find("img").attr("src", t.ImgSrc)
              : (e.append(
                  tt(
                    '<div class="item-thumb" style=""><img src="?"></div>',
                    t.ImgSrc
                  )
                ),
                e.addClass("item-image")),
            e.find(".item-desc").removeAttr("style"))
          : "" == t.ImgSrc &&
            (e.find(".item-thumb").remove(), e.removeClass("item-image"));
    }
  }),
  ...
  (Note.showEditorMask = function() {
    $("#editorMask")
      .css("z-index", 10)
      .show(),
      Notebook.curNotebookIsTrashOrAll()
        ? ($("#editorMaskBtns").hide(), $("#editorMaskBtnsEmpty").show())
  ...
  (Note.setNotesSorter = function(t) {
    ...
    e || (e = "dateUpdatedDESC"),
      ...
      Note.checkSorter(e),
      Note._isTag || Note._isSearch || Note._isShare
        ? Note.renderNotesAndFirstOneContent(Note._everNotes, !1)
...
(Note.checkSorter = function(t) {
  ...
  var e = $(".sorter-" + t);
  e.is(".checked") ||
    ($sorterStyles.removeClass("checked"), e.addClass("checked"));
}),
  ...
  (Note.getSorterAndOrder = function() {
    ...
    return console.log({ sortBy: t, isAsc: e }), { sortBy: t, isAsc: e };
  }),
  ...
  (Note.renderNotes = function(t, e, o, a) {
    ...
    if (
      ...
      !t || "object" != typeof t || t.length <= 0)
    )
      return void (e || Note.showEditorMask());
    Note.hideEditorMask(),
      void 0 == e && (e = !1),
  ...
  (Note._renderNotes = function(t, e, o, a) {
    for (var n = t.length, i = 20 * (a - 1); n > i && 20 * a > i; ++i) {
      ...
      (Note.nowIsInShared = !1),
        (o || r.UserId != UserInfo.UserId) &&
          ((s = "item-shared"), (Note.nowIsInShared = !0)),
        e || 0 != i || (s += " item-active");
      var c;
      (c = r.ImgSrc
        ? tt(
            ...
            r.ImgSrc,
            r.Title,
            Notebook.getNotebookTitle(r.NotebookId),
            goNowToDatetime(r.UpdatedTime),
            r.Desc
          )
        : tt(
            Note.itemTplNoImg,
  ...
  (Note.newNote = function(t, e, o, a) {
    ...
    (i = e
      ...
      Notebook.isCurNotebook(t)
        ? Note.noteItemListO.prepend(i)
        : (Note.clearAll(),
          Note.noteItemListO.prepend(i),
          e
            ? Share.changeNotebookForNewNote(t)
            : Notebook.changeNotebookForNewNote(t)),
  ...
  (Note.changeToNextSkipNotes = function(t) {
    var e = Note;
    if (!isEmpty(t)) {
      if (e.$itemList.find("li").length == t.length)
        return void e.showEditorMask();
      if (1 == t.length) {
        var o = e.$itemList.find(".item-active");
        if (1 == o.length && o.attr("noteId") != t[0]) return;
      }
      for (
        var a = e.getTargetById(t[0]),
          n = a.next(),
          i = 1,
          r = t.length,
          s = !1;
  ...
  (Note.deleteNote = function(t, e, o) {
    var a,
      n = Note;
    if (
      ((a = n.inBatch ? n.getBatchNoteIds() : [$(t).attr("noteId")]),
      !isEmpty(a))
    ) {
      1 == a.length &&
        $(t).hasClass("item-active") &&
        (Note.stopInterval(), n.clearCurNoteId(), Note.clearNoteInfo());
      var i;
      (i = 1 == a.length ? $(t) : n.$itemList.find(".item-active")),
        i.hide(),
        ajaxPost("/note/deleteNote", { noteIds: a, isShared: o }, function(t) {
          if (t) {
            ...
            for (var e = 0; e < a.length; ++e) {
              var o = a[e],
                r = n.getNote(o);
              r &&
                (Notebook.minusNotebookNumberNotes(r.NotebookId),
  ...
  (Note.listNoteShareUserInfo = function(t) {
    var e = $(t).attr("noteId");
    showDialogRemote("/share/listNoteShareUserInfo", { noteId: e });
  }),
  ...
  (Note.download = function(t, e) {
    ...
    $(
      '<form target="mdImageManager" action="' +
        t +
        '" method="GET">' +
        o +
        "</form>"
  ...
  (Note.exportPDF = function(t) {
    var e = $(t).attr("noteId");
    $(
      '<form target="mdImageManager" action="/note/exportPdf" method="GET"><input name="noteId" value="' +
        e +
        '"/></form>'
    )
      .appendTo("body")
  ...
  (Note.isSameSearch = function(t) {
    ...
    return (
      (Note.isOver2Seconds = o > 2e3 ? !0 : !1),
      !Note.lastKey || Note.lastKey != t || o > 1e3
        ? ((Note.lastKey = t), (Note.lastSearchTime = e), !1)
        : t == Note.lastKey
        ? !0
        : ((Note.lastSearchTime = e), (Note.lastKey = t), !1)
    );
  }),
  (Note.searchNote = function() {
    ...
    return t
      ? void (
          Note.isSameSearch(t) ||
          (Note.lastSearch && Note.lastSearch.abort(),
          Note.curChangedSaveIt(),
          Note.clearAll(),
          showLoading(),
          ...
          Note.listIsIn(!1, !0),
          $("#tagSearch").hide(),
          (Note.lastSearch = $.post("/note/searchNote", { key: t }, function(
            t
          ) {
            hideLoading(),
              ...
              t &&
                ((Note.lastSearch = null),
                Note.renderNotes(t),
                isEmpty(t) || Note.changeNote(t[0].NoteId, !1));
          })))
        )
  ...
  (Note._setBlog = function(t, e) {
    ...
    (o = Note.inBatch ? a.getBatchNoteIds() : [$(t).attr("noteId")]),
      ajaxPost("/note/setNote2Blog", { noteIds: o, isBlog: e }, function(t) {
        if (t)
          for (var n = 0; n < o.length; ++n) {
            var i = o[n],
              r = a.getTargetById(i);
            e ? r.addClass("item-b") : r.removeClass("item-b"),
              a.setNoteCache({ NoteId: i, IsBlog: e }, !1);
          }
      });
  }),
  (Note.setAllNoteBlogStatus = function(t, e) {
    if (t) {
      ...
      if (isArray(o)) {
        var a = o.length;
        if (0 == a)
          for (var n in Note.cache)
            Note.cache[n].NotebookId == t && (Note.cache[n].IsBlog = e);
  ...
  (Note.moveNote = function(t, e) {
    ...
    if (Notebook.getCurNotebookId() != n) {
      ...
      ajaxPost("/note/moveNote", { noteIds: o, notebookId: n }, function(e) {
        if (e) {
          ...
          for (var i = 0; i < o.length; ++i) {
            ...
            s &&
              (s.NotebookId != n
                ? (Notebook.incrNotebookNumberNotes(n),
                  s.IsTrash || Notebook.minusNotebookNumberNotes(s.NotebookId))
                : s.IsTrash && Notebook.incrNotebookNumberNotes(s.NotebookId),
              a.clearCacheByNotebookId(s.NotebookId),
              (s.NotebookId = n),
              (s.IsTrash = !1),
          ...
          (c = 1 == o.length ? t : a.$itemList.find(".item-active")),
            Notebook.curActiveNotebookIsAll()
              ? (c.find(".note-notebook").html(Notebook.getNotebookTitle(n)),
                a.changeNote(c.eq(0).attr("noteId")))
              : (a.changeToNextSkipNotes(o), c.remove());
        }
      }),
        a.batch.reset();
    }
      ...
      ajaxPost(d, e, function(t) {
        if (reIsOk(t)) {
          ...
          for (var o = 0; o < e.length; ++o) {
            var a = e[o];
            a.NoteId &&
              (Note.setNoteCache(a), Notebook.incrNotebookNumberNotes(i));
          }
        }
      });
    }
  ...
  (Note.toggleReadOnly = function(t) {
    ...
    a.addClass("read-only").removeClass("all-tool"),
      ...
      o &&
        ...
        o.IsMarkdown
          ? ($("#mdInfoToolbar .created-time").html(
              goNowToDatetime(o.CreatedTime)
            ),
            $("#mdInfoToolbar .updated-time").html(
              goNowToDatetime(o.UpdatedTime)
            ))
          : ($("#infoToolbar .created-time").html(
              goNowToDatetime(o.CreatedTime)
            ),
            $("#infoToolbar .updated-time").html(
              goNowToDatetime(o.UpdatedTime)
            )),
        t && Note.curChangedSaveIt(),
        (Note.readOnly = !0),
        (LEA.readOnly = !0),
        o.IsMarkdown ||
  ...
  (Note.getContextNotebooks = function(t) {
    ...
    for (var n in t) {
      var i = t[n],
        r = { text: i.Title, notebookId: i.NotebookId, action: Note.moveNote },
        s = { text: i.Title, notebookId: i.NotebookId, action: Note.copyNote },
        c = {
          text: i.Title,
    ...
    function t(t) {
      ...
      if (Note.inBatch)
        o.push("shareToFriends"),
          o.push("exportPDF"),
          Notebook.curActiveNotebookIsTrash() &&
            (o.push("shareStatus"),
            o.push("unset2Blog"),
            o.push("set2Blog"),
            o.push("copy"));
        ...
        if (!a) return;
        if (a.IsTrash || Notebook.curActiveNotebookIsTrash())
          o.push("shareToFriends"),
            o.push("shareStatus"),
            o.push("unset2Blog"),
            o.push("set2Blog"),
      ...
      t.applyrule({ name: "target..", disable: !0, items: o });
    }
    function e() {
...
var Attach = {
    ...
    $("#showAttach").click(function() {
      ...
      t.attachListO.on("click", ".delete-attach", function(e) {
        ...
        var o = $(this)
            ...
            .data("id"),
          a = this;
        confirm(getMsg("Are you sure to delete it ?")) &&
          ($(a).button("loading"),
          ajaxPost("/attach/deleteAttach", { attachId: o }, function(e) {
      ...
      t.attachListO.on("click", ".download-attach", function(t) {
        ...
        var e = $(this)
          .closest("li")
          .data("id");
        Note.download("/attach/download", { attachId: e });
      }),
      ...
      t.attachListO.on("click", ".link-attach", function(e) {
        ...
        Note.toggleWriteable(),
          LEA.isMarkdownEditor() && MD
            ? MD.insertLink(n, a.Title)
            : tinymce.activeEditor.insertContent(
                '<a target="_blank" href="' + n + '">' + a.Title + "</a>"
              );
      });
  },
  ...
  renderNoteAttachNum: function(t, e) {
    var o = this,
      a = Note.getNote(t);
    a.AttachNum
      ? (o.attachNumO.html("(" + a.AttachNum + ")").show(),
        o.downloadAllBtnO.show(),
        o.linkAllBtnO.show())
      : (o.attachNumO.hide(), o.downloadAllBtnO.hide(), o.linkAllBtnO.hide()),
  ...
  _renderAttachs: function(t) {
    for (
      var e = this,
        ...
        n = getMsg("Delete"),
        i = getMsg("Download"),
        r = getMsg("Insert link into content"),
        s = 0;
      a > s;
      ++s
    ) {
      var c = t[s];
      (o +=
        '<li class="clearfix" data-id="' +
        c.AttachId +
        '"><div class="attach-title">' +
        c.Title +
        '</div><div class="attach-process"> 	  <button class="btn btn-sm btn-warning delete-attach" data-loading-text="..." title="' +
        n +
        '"><i class="fa fa-trash-o"></i></button> 	  <button type="button" class="btn btn-sm btn-primary download-attach" title="' +
        i +
        '"><i class="fa fa-download"></i></button> 	  <button type="button" class="btn btn-sm btn-default link-attach" title="' +
        r +
        '"><i class="fa fa-link"></i></button> </div></li>'),
  ...
  renderAttachs: function(t) {
    var e = this;
    return e.loadedNoteAttachs[t]
      ? void e._renderAttachs(e.loadedNoteAttachs[t])
      : (e.attachListO.html(
          '<li class="loading"><img src="/images/loading-24.gif"/></li>'
        ),
        void ajaxGet("/attach/getAttachs", { noteId: t }, function(o) {
          var a = [];
          o.Ok && ((a = o.List), a || (a = [])),
  ...
  deleteAttach: function(t) {
    for (
      var e = this, o = Note.curNoteId, a = e.loadedNoteAttachs[o], n = 0;
      n < a.length;
      ++n
    )
      if (a[n].AttachId == t) {
...
(Note.inBatch = !1),
  (Note.getBatchNoteIds = function() {
    for (
      var t = [], e = Note.$itemList.find(".item-active"), o = 0;
      o < e.length;
      ++o
    )
      t.push(e.eq(o).attr("noteId"));
    return t;
  }),
  (Note.batch = {
    ...
    getStartNoteO: function() {
      var t = this;
      return (
        t._startNoteO || (t._startNoteO = t.getCurSelected()), t._startNoteO
      );
    },
    _selectByStart: {},
    ...
    selectTo: function(t) {
      ...
      for (var d = n; i >= d; ++d)
        this.selectTarget(l), this._selectByStart[c].push(l), (l = l.next());
    },
    selectAll: function() {
      ...
      t.$noteItemList.on("click", ".item", function(e) {
        ...
        if (a) {
          var n = !1,
            i = !1;
          t.canBatch() &&
            (e.shiftKey ? (i = !0) : (n = e.metaKey || e.ctrlKey)),
        ...
        (t._startMove = !1),
        t.$noteItemList.on("mousedown", ".item", function(e) {
          t.canBatch() &&
            (t.isContextMenu(e) ||
              ((t._startMove || !(e.metaKey || e.ctrlKey || e.shiftKey)) &&
                ((t._startNoteO = $(this)), (t._startMove = !0))));
        }),
        t.$noteItemList.on("mousemove", ".item", function(e) {
          t.canBatch() &&
            t._startMove &&
            (Note.curChangedSaveIt(),
            t.clearAllSelect(),
      ...
      e.on("mouseup", function() {
        ...
        e.keydown(function(e) {
          e.target &&
            ...
            (e.preventDefault(),
            t.canBatch() &&
              (Note.curChangedSaveIt(), t.selectAll(), t.finalFix()));
        }),
    ...
    initContextmenu: function() {
      ...
      t.$batchMask.on("contextmenu", function(t) {
        t.preventDefault(),
          Note.nowIsInShared
            ? Share.contextmenu.showMenu(t)
            : Note.contextmenu.showMenu(t);
      }),
    ...
    finalFix: function(t) {
      var e = this;
      if (e.isInBatch())
        Note.clearCurNoteId(), e.renderBatchNotes(), e.setInBatch();
      else {
    ...
    isContextMenu: function(t) {
      return (void 0 != t.which && 1 == t.which) || 1 == t.button
        ? !1
        : (void 0 != t.which && 3 == t.which) || 2 == t.button
        ? !0
        : !1;
    },
    _notes: {},
    ...
    renderBatchNotes: function() {
      ...
      for (var n in t._notes)
        if (!o[n]) {
          var i = t._notes[n];
          i.css({ "margin-left": "-800px" }),
            setTimeout(function() {
              i.remove();
            }, 500),
            delete t._notes[n];
    ...
    addTo: function(t) {
      ...
      if (!e._notes[t]) {
        var o = Note.getNote(t),
          ...
          n = o.Desc || "...",
          i = $(
            '<div class="batch-note"><div class="title">' +
              a +
  ...
  $(function() {
    Attach.init(),
      $("#noteItemList").on("mouseenter", ".item", function(t) {
      ...
      $("#searchNoteInput").on("keydown", function(t) {
        var e = t.keyCode || t.witch;
        return 13 == e || 108 == e
          ? (t.preventDefault(), Note.searchNote(), !1)
          : void 0;
      }),
...
function sendLog(e, t) {
  e && (t || (t = ""), ajaxGet("/index/log", { key: e, value: t }));
}
function editorMode() {
...
function initSlimScroll() {
  Mobile.isMobile() ||
    ($("#notebook").slimScroll({ height: "100%" }),
    $("#noteItemList").slimScroll({ height: "100%" }),
    $("#wmd-panel-preview").slimScroll({ height: "100%" }),
  ...
  $("#moreBtn").click(function() {
    ...
    tinymce.init({
      ...
      setup: function(e) {
        e.on("keydown", function(e) {
          ...
          return !Note.readOnly || ((e.ctrlKey || e.metaKey) && 67 == t)
            ? void LeaAce.removeCurToggleRaw()
            : void e.preventDefault();
        }),
          e.on("cut", function(e) {
            return $(e.target).hasClass("ace_text-input")
              ? void e.preventDefault()
              : void 0;
          });
      },
      ...
      language: LEA.locale,
      plugins: [
        "autolink link leaui_image leaui_mindmap lists hr",
        "paste",
        "searchreplace leanote_nav leanote_code tabfocus",
        "table textcolor"
      ],
      toolbar1:
        "formatselect | forecolor backcolor | bold italic underline strikethrough | leaui_image leaui_mindmap | leanote_code leanote_inline_code | bullist numlist | alignleft aligncenter alignright alignjustify",
      toolbar2:
        "outdent indent blockquote | link unlink | table | hr removeformat | subscript superscript |searchreplace | pastetext | leanote_ace_pre | fontselect fontsizeselect",
      menubar: !1,
      toolbar_items_size: "small",
      statusbar: !1,
      url_converter: !1,
      font_formats:
        "Arial=arial,helvetica,sans-serif;Arial Black=arial black,avant garde;Times New Roman=times new roman,times;Courier New=courier new,courier;Tahoma=tahoma,arial,helvetica,sans-serif;Verdana=verdana,geneva;宋体=SimSun;新宋体=NSimSun;黑体=SimHei;微软雅黑=Microsoft YaHei",
      block_formats:
        "Header 1=h1;Header 2=h2;Header 3=h3;Header 4=h4;Paragraph=p",
      paste_data_images: !0
    }),
    (window.onbeforeunload = function(e) {
      LEA.isLogout || Note.curChangedSaveIt(!0, null, { refresh: !0 });
    }),
    $("body").on("keydown", function(e) {
      ...
      if (o) {
        if (83 == t)
          return (
            Note.curChangedSaveIt(!0, null, { ctrls: !0 }),
            e.preventDefault(),
            !1
          );
        if (69 == t)
          return Note.toggleWriteableAndReadOnly(), e.preventDefault(), !1;
      }
    });
}
function scrollTo(e, t, o) {
  ...
  random++;
  for (
    var r = $('#leanoteNavContent [data-a="' + t + "-" + encodeURI(o) + '"]'),
      a = r.size(),
      s = 0;
    a > s && r[s] != e;
    ++s
  ...
  if (n.size() >= s + 1) {
    ...
    return void i.animate({ scrollTop: l }, 300);
  }
}
function hideMask() {
...
function updateLeftIsMin(e) {
  ajaxGet("/user/updateLeftIsMin", { leftIsMin: e });
}
function minLeft(e) {
...
function initLeanoteIfrPlugin() {
  self != window.parent &&
    ...
    window.parent.postMessage && window.parent.postMessage("leanote", "*"));
}
function getNoteBySrc(e, t) {
  ajaxGet("/note/getNoteAndContentBySrc", { src: e }, function(e) {
    if (e && e.Ok) {
      var o = e.Item;
      if (o) {
        var i = o.NoteInfo,
...
function getTopInfoSrc(e) {
  return LEA.topInfo.got
    ? e(LEA.topInfo.src)
    : new Date().getTime() - _topInfoStart > 2e3
    ? e()
...
function initPage() {
  initLeanoteIfrPlugin(),
    LEA.topInfo
      ? getTopInfoSrc(function(e) {
          e
            ? getNoteBySrc(e, function(e) {
                _initPage(e, !0);
              })
            : _initPage(!1, !0);
        })
  ...
  if (
    ...
    Note.renderNotes(notes),
      curNoteId &&
        ...
        curNotebookId ||
          Notebook.selectNotebook(
            $(tt('#notebook [notebookId="?"]', Notebook.allNotebookId))
          ));
  }
...
(editorMode.prototype.toggleAText = function(e) {
  ...
  setTimeout(function() {
    ...
    e
      ? (o.attr("href", "#" + t.normalHash), i.text(getMsg("normalMode")))
      : (o.attr("href", "#" + t.writingHash), i.text(getMsg("writingMode")));
  }, 0);
}),
  ...
  (editorMode.prototype.normalMode = function() {
    ...
    e += ".css";
    $("#themeLink");
    -1 != this.$themeLink.attr("href").indexOf("writting-overwrite.css") &&
      this.$themeLink.attr("href", LEA.sPath + "/css/theme/" + e),
  ...
  (editorMode.prototype.writtingMode = function() {
    Note.inBatch ||
      (-1 == this.$themeLink.attr("href").indexOf("writting-overwrite.css") &&
        this.$themeLink.attr(
          "href",
          LEA.sPath + "/css/theme/writting-overwrite.css"
        ),
...
var Resize = {
  ...
  initEvent: function() {
    ...
    $(".noteSplit").bind("mousedown", function(t) {
      ...
      e.body.bind("mousemove", function(t) {
        e.lineMove
          ? (t.preventDefault(), e.resize3Columns(t))
          : e.mdLineMove && (t.preventDefault(), e.resizeMdColumns(t));
      }),
      e.body.bind("mouseup", function(t) {
  ...
  resize3Columns: function(e, t) {
    ...
    var i, n;
    o.lineMove &&
      ("notebookSplitter" == o.target
        ? ((i = e.clientX), (n = o.noteList.width()), o.set3ColumnsWidth(i, n))
  ...
  setMdColumnWidth: function(e) {
    ...
    e > 100 &&
      o - 80 > e &&
      ((UserInfo.MdEditorWidth = e),
      t.leftColumn.width(e),
      t.rightColumn.css("left", e)),
      MD && MD.onResize();
  }
};
Mobile = {
  ...
  toEditor: function(e, t) {
    var o = this;
    o.bodyO.addClass("full-editor"), o.noteO.addClass("editor-show");
  },
  toNormal: function(e) {
    var t = this;
    t.bodyO.removeClass("full-editor"), t.noteO.removeClass("editor-show");
  },
  switchPage: function() {
    var e = this;
    return !LEA.isMobile || LEA.isIpad
      ? !0
      : (e.bodyO.hasClass("full-editor") ? e.toNormal(!0) : e.toEditor(!0), !1);
  }
};
var random = 1;
(LEA.s3 = new Date()),
    ...
    showDialog2("#setThemeDialog", {
      ...
      postShow: function() {
        UserInfo.Theme || (UserInfo.Theme = "default"),
          $("#themeForm input[value='" + UserInfo.Theme + "']").attr(
            "checked",
            !0
          );
      }
  ...
  $("#themeForm").on("click", "input", function(e) {
    ...
    2 == i.length && (n = i[1]),
      $("#themeLink").attr(
        "href",
        LEA.sPath + "/css/theme/" + t + ".css?id=" + n
      ),
      ajaxPost("/user/updateTheme", { theme: t }, function(e) {
        reIsOk(e) && (UserInfo.Theme = t);
      });
  }),
  $(
    "#notebook, #newMyNote, #myProfile, #topNav, #notesAndSort",
    "#leanoteNavTrigger"
...
var Pjax = {
  init: function() {
    ...
    window.addEventListener(
      ...
      function(t) {
        var o = t.state;
        o &&
          ((document.title = o.title || "Untitled"),
          log("pop"),
          e.changeNotebookAndNote(o.noteId));
      },
      !1
    ),
      history.pushState ||
  ...
  changeNotebookAndNote: function(e) {
    ...
    if (t) {
      var o = void 0 != t.Perm,
        i = t.NotebookId;
      return Notebook.curNotebookId == i
        ? void Note.changeNoteForPjax(e, !1)
        : void (o
            ? Share.changeNotebook(t.UserId, i, function(t) {
  ...
  changeNote: function(e) {
    var t = e.NoteId,
      ...
      i = "/note/" + t;
    if (
      (location.href.indexOf("?online") > 0 &&
        (i += "?online=" + /online=([0-9])/.exec(location.href)[1]),
      location.hash && (i += location.hash),
      history.pushState)
    ) {
      var n = { url: i, noteId: t, title: o };
...
$(function() {
  ...
  (LeaAce = {
    ...
    canAce: function() {
      return this._isInit
        ? this._canAce
        : ("webkit" != getVendorPrefix() || Mobile.isMobile()
            ? (this._canAce = !1)
            : (this._canAce = !0),
          (this._isInit = !0),
          this._canAce);
    ...
    getAceId: function() {
      return (
        this.aceId++, "leanote_ace_" + new Date().getTime() + "_" + this._aceId
      );
    },
      ...
      if (o || i.canAndIsAce()) {
        ...
        if (0 != n.length) {
          ...
          try {
            ...
            (n.attr("style") || (!s && -1 != n.html().indexOf("style"))) &&
              n.html(n.text()),
            ...
            return (
              ...
              l.commands.addCommand({
                ...
                exec: function(e) {
                  ...
                  t.hasUndo()
                    ? t.undo()
                    : (t.reset(), tinymce.activeEditor.undoManager.undo());
                }
              }),
      ...
      if (this.canAndIsAce()) {
        ...
        t.clearIntervalForInitAce && clearInterval(t.clearIntervalForInitAce),
          (t.clearIntervalForInitAce = setTimeout(function() {
            for (
              var o = $(e.getBody()), i = o.find("pre"), n = 0;
              n < i.length;
              ++n
            ) {
              var r = i.eq(n);
    ...
    destroyAceFromContent: function(e) {
      if (this.canAce())
        for (var t = e.find("pre"), o = 0; o < t.length; ++o) {
    ...
    isInPre: function(e) {
      ...
      return "PRE" == e.nodeName
        ? !0
        : (($pre = t.closest("pre")), 0 == $pre.length ? !1 : !0);
    },
    isInAce: function(e) {
      if (this.canAce()) {
        var t = $(e),
        ...
        return (
          ($pre = t.closest("pre")), 0 == $pre.length ? !1 : this.isInAce($pre)
        );
      }
    },
    ...
    aceToPre: function(e, t) {
      ...
      if (n) {
        ...
        var s = $(
          '<pre class="' + i.attr("class") + ' ace-to-pre">' + a + "</pre>"
        );
        i.replaceWith(s),
          r.destroy(),
    ...
    handleEvent: function() {
      if (this.canAce()) {
        var e = this;
        $("#editorContent").on("mouseenter", "pre", function(t) {
          var o = $(this);
          if ((($raw = o.find(".toggle-raw")), 0 == $raw.length)) {
            var i = $(
              '<div class="toggle-raw" title="Toggle code with raw html"><input type="checkbox" /></div>'
            );
            o.append(i), (e.curToggleRaw = i);
          }
          ...
          if (8 == i || 46 == i)
            if (t) {
              ...
              if (300 > n - t) {
                ...
                if (r && !r[0].getValue())
                  return r[0].destroy(), void $(this).remove();
              }
              t = n;
...
function reRenderTags() {
  ...
  $("#tags")
    ...
    .each(function() {
      ...
      ("label label-default" == t || "label label-info" == t) &&
        ($(this)
          .removeClass(t)
          .addClass(a[e % 2]),
        e++);
...
(Tag.classes = {
  ...
  (Tag.mapCn2En = { 蓝色: "blue", 红色: "red", 绿色: "green", 黄色: "yellow" }),
  (Tag.mapEn2Cn = { blue: "蓝色", red: "红色", green: "绿色", yellow: "黄色" }),
  (Tag.t = $("#tags")),
  ...
  (Tag.appendTag = function(a, e) {
    ...
    var g = l;
    "zh" == LEA.locale &&
      ((l = Tag.mapEn2Cn[l] || l), (g = Tag.mapCn2En[g] || g)),
      (a = tt(
        '<span class="?" data-tag="?">?<i title="' +
          getMsg("delete") +
          '">X</i></span>',
        t,
        l,
    ...
    $("#tags")
      ...
      e &&
        (s ||
          Note.curChangedSaveIt(!0, function() {
            ajaxPost("/tag/updateTag", { tag: g }, function(a) {
  ...
  (Tag.renderTagNav = function(a) {
    ...
    for (var e in a) {
      ...
      if ((n = trimTitle(n))) {
        ...
        $("#tagNav").append(
          tt(
            '<li data-tag="?"><a> <span class="?">?</span> <span class="tag-delete">X</span></li>',
            l,
            g,
            n
          )
  ...
  $(function() {
    function a() {
      ...
      confirm("Are you sure ?") &&
        ajaxPost("/tag/deleteTag", { tag: a }, function(e) {
          if (reIsOk(e)) {
            var t = e.Item;
    ...
    function e() {
      ...
      Note.curChangedSaveIt(),
        ...
        Note.listIsIn(!0, !1),
        showLoading(),
        ajaxGet("/note/searchNoteByTags", { tags: [e] }, function(a) {
          hideLoading(),
            a &&
              (Note.renderNotes(a), isEmpty(a) || Note.changeNote(a[0].NoteId));
        });
    }
    $("#addTagTrigger").click(function() {
      ...
      $("#addTagInput").keydown(function(a) {
        13 == a.keyCode &&
          (hideTagList(),
          $("#addTagInput").val()
            ? ($(this).trigger("blur"), $("#addTagTrigger").trigger("click"))
            : $(this).trigger("blur"));
      }),
      $("#tagColor li").click(function(a) {
        var e;
        (e = $(this).attr("role") ? $(this).find("span") : $(this)),
          Tag.appendTag({ classes: e.attr("class"), text: e.text() }, !0);
      }),
...
(Notebook.curNotebookId = ""),
  ...
  (Notebook.setCache = function(o) {
    var e = o.NotebookId;
    e &&
      (Notebook.cache[e] || (Notebook.cache[e] = {}),
      $.extend(Notebook.cache[e], o));
  }),
  ...
  (Notebook._updateNotebookNumberNotes = function(o, e) {
    ...
    N &&
      ((N.NumberNotes += e),
      N.NumberNotes < 0 && (N.NumberNotes = 0),
      $("#numberNotes_" + o).html(N.NumberNotes));
  }),
  ...
  (Notebook.getTreeSetting = function(o, e) {
    function t(o, t) {
      ...
      if (
        ...
        n.before(a),
        e
          ? Share.isDefaultNotebookId(t.NotebookId) ||
            n.after(
              $('<span class="fa notebook-setting" title="setting"></span>')
            )
          : Notebook.isAllNotebookId(t.NotebookId) ||
            Notebook.isTrashNotebookId(t.NotebookId) ||
            (n.after(
              $(
                '<span class="notebook-number-notes" id="numberNotes_' +
                  t.NotebookId +
                  '">' +
                  (t.NumberNotes || 0) +
                  "</span>"
    ...
    function n(o, e, t, N, a) {
      ...
      if (N) {
        ...
        for (var l in c) {
          ...
          Notebook.isAllNotebookId(h) ||
            Notebook.isTrashNotebookId(h) ||
            s.siblings.push(h);
        }
        ajaxPost("/notebook/dragNotebooks", { data: JSON.stringify(s) }),
          setTimeout(function() {
            Notebook.changeNav();
          }, 100);
      }
    ...
    var r = !o,
      b = this;
    if (e)
      var k = function(o, e, t) {
          var N = t.NotebookId,
            a = $(o.target)
              .closest(".friend-notebooks")
              .attr("fromUserId");
      ...
      var k = function(o, e, t) {
        ...
        i = function(o) {
          ...
          Notebook.isAllNotebookId(e) ||
            Notebook.isTrashNotebookId(e) ||
            b.updateNotebookTitle(o.target);
        };
    var s = {
      view: {
        showLine: !1,
      ...
      data: { key: { name: "Title", children: "Subs" } },
      edit: {
        enable: !0,
        showRemoveBtn: !1,
        showRenameBtn: !1,
        drag: { isMove: r, prev: r, inner: r, next: r }
      },
      callback: {
        beforeDrag: N,
        beforeDrop: a,
  ...
  (Notebook.curNotebookIsTrashOrAll = function() {
    return (
      Notebook.curNotebookId == Notebook.trashNotebookId ||
      Notebook.curNotebookId == Notebook.allNotebookId
    );
  }),
  (Notebook.renderNotebooks = function(o) {
    ...
    n.hover(
      ...
      isEmpty(o) ||
        ((Notebook.curNotebookId = o[0].NotebookId), e.cacheAllNotebooks(o)),
      Notebook.renderNav(),
  ...
  (Notebook.searchNotebookForAddNote = function(o) {
    ...
    if (o) {
      ...
      isEmpty(N)
        ...
        : $("#notebookNavForNewNote").html(e.getChangedNotebooks(N));
  ...
  (Notebook.getChangedNotebooks = function(o) {
    for (var e = this, t = "", N = o.length, a = 0; N > a; ++a) {
      ...
      var b = tt(
        '<li role="presentation" class="clearfix ?"><div class="new-note-left pull-left" title="为该笔记本新建笔记" href="#" notebookId="?">?</div><div title="为该笔记本新建markdown笔记" class="new-note-right pull-left" notebookId="?">M</div>',
        r,
        n.NotebookId,
        n.Title,
        n.NotebookId
      ...
      isEmpty(n.Subs) ||
        ...
        (b += e.getChangedNotebooks(n.Subs)),
        (b += "</ul>")),
        (b += "</li>"),
        (t += b);
    }
  ...
  (Notebook.renderShareNotebooks = function(o, e) {
    if (!isEmpty(o) && e && "object" == typeof e && !(e.length < 0)) {
      ...
      for (var a in o) {
        var r = o[a],
          n = N[r.UserId] || { ShareNotebooks: [] };
        n.ShareNotebooks = [{ NotebookId: "-2", Title: "默认共享" }].concat(
          n.ShareNotebooks
        );
        var b = r.Username || r.Email,
          k = tt(
            '<div class="folderNote closed"><div class="folderHeader"><a><h1 title="? 的共享"><i class="fa fa-angle-right"></i>?</h1></a></div>',
            b,
            b
          ),
  ...
  (Notebook.changeNotebookNavForNewNote = function(o, e) {
    ...
    if (Notebook.isAllNotebookId(o) || Notebook.isTrashNotebookId(o)) {
      if (
        !$("#curNotebookForNewNote").attr("notebookId") &&
        Notebook.notebooks.length > 2
      ) {
  ...
  (Notebook.changeNotebookNav = function(o) {
    ...
    var e = Notebook.cache[o];
    e &&
      ($("#curNotebookForListNote").html(e.Title),
      Notebook.changeNotebookNavForNewNote(o, e.Title));
  }),
  ...
  (Notebook.curActiveNotebookIsAll = function() {
    return Notebook.isAllNotebookId(
      $("#notebookList .curSelectedNode").attr("notebookId")
    );
  }),
  (Notebook.curActiveNotebookIsTrash = function() {
    return Notebook.isTrashNotebookId(
      $("#notebookList .curSelectedNode").attr("notebookId")
    );
  }),
  ...
  (Notebook.changeNotebook = function(o, e) {
    ...
    if (Notebook.isTrashNotebookId(o)) (N = "/note/listTrashNotes"), (a = {});
      ...
      if (
        ...
        return void (e
          ? e(cacheNotes)
          : Note.renderNotesAndFirstOneContent(cacheNotes, !0));
    } else {
    ...
    t.showNoteAndEditorLoading(),
      ...
      (function(o) {
        ajaxGet(N, a, function(N) {
          return o != t.changeNotebookSeq
            ? (log("notebook changed too fast!"), void log(N))
            : (e ? e(N) : Note.renderNotesAndFirstOneContent(N, !1),
              void t.hideNoteAndEditorLoading());
        });
      })(t.changeNotebookSeq);
  }),
  ...
  (Notebook.isCurNotebook = function(o) {
    return (
      ...
      $(
        tt(
          '#notebookList [notebookId="?"], #shareNotebooks [notebookId="?"]',
          o,
          o
        )
      ).attr("class")
  ...
  (Notebook.listNotebookShareUserInfo = function(o) {
    ...
    showDialogRemote("/share/listNotebookShareUserInfo", { notebookId: e });
  }),
  (Notebook.shareNotebooks = function(o) {
    var e = $(o).text();
    showDialog("dialogShareNote", { title: "分享笔记本给好友-" + e }),
      setTimeout(function() {
        $("#friendsEmail").focus();
      }, 500);
        ...
        : Notebook.curNotebookId == Notebook.allNotebookId &&
          $("#noteItemList .item").each(function() {
            var o = $(this).attr("noteId"),
              t = Note.cache[o];
            t.NotebookId == e &&
              (N ? $(this).addClass("item-b") : $(this).removeClass("item-b"));
          }),
      ajaxPost(
        "/notebook/setNotebook2Blog",
        { notebookId: e, isBlog: N },
        function(o) {
          o &&
            (Note.setAllNoteBlogStatus(e, N),
            Notebook.setCache({ NotebookId: e, IsBlog: N }));
        }
      );
  }),
  ...
  (Notebook.addNotebook = function() {
    ...
    $("#myNotebooks").hasClass("closed") &&
      ...
      o.tree.addNodes(
        null,
        { Title: "", NotebookId: getObjectId(), IsNew: !0 },
        !0,
        !0
      );
  }),
  (Notebook.doAddNotebook = function(o, e, t) {
    ...
    ajaxPost(
      ...
      { notebookId: o, title: e, parentNotebookId: t },
      function(e) {
        if (e.NotebookId) {
  ...
  (Notebook.deleteNotebook = function(o) {
    var e = Notebook,
      t = $(o).attr("notebookId");
    t &&
      ajaxGet("/notebook/deleteNotebook", { notebookId: t }, function(o) {
        o.Ok
          ? (e.tree.removeNode(e.tree.getNodeByTId(t)),
            e.tree2 && e.tree2.removeNode(e.tree2.getNodeByTId(t)),
            delete Notebook.cache[t],
            Notebook.changeNav())
          : alert(o.Msg);
      });
  }),
  $(function() {
    function o(o) {
      ...
      if (t) {
        ...
        t.IsBlog ? N.push("set2Blog") : N.push("unset2Blog"),
          ...
          o.applyrule({ name: "target2", disable: !0, items: N });
      }
    }
    function e() {
    ...
    (Notebook.contextmenu = $("#notebookList li a").contextmenu(t)),
      (Notebook.contextmenuSearch = $(
        "#notebookListForSearch li a"
      ).contextmenu(N)),
...
function addShareNoteOrNotebook(e) {
  var t = "#tr" + e,
    ...
    r = isEmailFromInput(
      t + " #friendsEmail",
      "#shareMsg",
      getMsg("inputFriendEmail")
    );
  if (r) {
    var a = $(t + ' input[name="perm' + e + '"]:checked').val() || 0,
      n = a,
      s = "/share/addShareNote",
      i = { noteId: o, emails: [r], perm: a };
    Share.dialogIsNote ||
      ((s = "/share/addShareNotebook"),
      (i = { notebookId: o, emails: [r], perm: a })),
      hideAlert("#shareMsg"),
      post(
        s,
        i,
        function(e) {
          ...
          if (e)
            if (e.Ok) {
              ...
              (a += tt("<td>?</td>", r)),
                (a += tt(
                  '<td><a href="#" noteOrNotebookId="?" perm="?" toUserId="?" title="' +
                    getMsg("clickToChangePermission") +
                    '" class="btn btn-default change-perm">?</a></td>',
                  o,
                  n,
                  e.Id,
                  n && "0" != n ? getMsg("writable") : getMsg("readOnly")
                )),
                (a += tt(
                  '<td><a href="#" noteOrNotebookId="?" toUserId="?" class="btn btn-warning delete-share">' +
                    getMsg("delete") +
                    "</a></td>",
                  o,
                  e.Id
              ...
              showAlert(
                "#shareMsg",
                getMsg("friendNotExits", [
                  getMsg("app"),
                  '<input style="background: none;border: 1px solid #ccc;width: 300px;padding: 3px;border-radius: 3px;outline: none;" onclick="$(this).focus().select()" type="text" value="' +
                    s +
                    '" />'
                ]) +
                  "</a> <br /> " +
                  getMsg("sendInviteEmailToYourFriend") +
                  ', <a href="#" onclick="sendRegisterEmail(\'' +
                  r +
                  "')\">" +
                  getMsg("send"),
                "warning"
...
function sendRegisterEmail(e) {
  showDialog2("#sendRegisterEmailDialog", {
    postShow: function() {
      $("#emailContent").val(
        getMsg("inviteEmailBody", [UserInfo.Username, getMsg("app")])
      ),
        setTimeout(function() {
          $("#emailContent").focus();
        }, 500),
...
(Share.defaultNotebookId = "share0"),
  ...
  (Share.getNotebooksForNew = function(e, t) {
    for (var o = this, r = "", a = t.length, n = 0; a > n; ++n) {
      ...
      if (s.Perm) {
        var h = tt(
          '<li role="presentation" class="clearfix ?" userId="?" notebookId="?"><div class="new-note-left pull-left" title="为该笔记本新建笔记" href="#">?</div><div title="为该笔记本新建markdown笔记" class="new-note-right pull-left">M</div>',
          i,
          e,
          s.NotebookId,
          s.Title
    ...
    if (!isEmpty(e)) {
      ...
      for (var s in e) {
        var i = e[s],
          d = t[i.UserId] || [];
        (userNotebooks = [
          { NotebookId: a.defaultNotebookId, Title: Share.defaultNotebookTitle }
        ].concat(d)),
        ...
        var l = i.UserId,
          c = tt(
            '<li class="each-user"><div class="friend-header" fromUserId="?"><i class="fa fa-angle-down"></i><span>?</span> <span class="fa notebook-setting" title="setting"></span> </div>',
            i.UserId,
            h
          ),
          N = "friendContainer_" + l,
          u =
            '<ul class="friend-notebooks ztree" id="' +
            N +
            '" fromUserId="' +
            l +
            '"></ul>';
        n.append(c + u + "</li>"),
          (a.trees[l] = $.fn.zTree.init(
            $("#" + N),
            Notebook.getTreeSetting(!0, !0),
            userNotebooks
          )),
          (a.userNavs[l] = { forNew: a.getNotebooksForNew(l, d) }),
          log(a.userNavs);
      }
      $(".friend-notebooks").hover(
        function() {
          $(this).hasClass("showIcon") || $(this).addClass("showIcon");
        },
        function() {
      ...
      $(".friend-header").on("click", ".notebook-setting", function(e) {
        ...
        $("#shareNotebooks .notebook-item").on(
          "click",
          ".notebook-setting",
          function(e) {
            e.preventDefault(), e.stopPropagation();
  ...
  (Share.toggleToSharedNav = function(e, t) {
    $("#curNotebookForListNote").html(
      Share.notebookCache[t].Title +
        "(" +
        Share.sharedUserInfos[e].Username +
        ")"
    ),
      Note.listIsIn(!1, !1, !0);
    ...
    if (o) {
      ...
      var r = "",
        a = "";
      if (Share.notebookCache[t].Perm)
        (r = t), (a = Share.notebookCache[t].Title);
      else {
        var n = $("#notebookNavForNewSharedNote li").eq(0);
        (r = n.attr("notebookId")), (a = n.find(".new-note-left").text());
      }
      $("#curNotebookForNewSharedNote").html(
        a + "(" + Share.sharedUserInfos[e].Username + ")"
      ),
  ...
  (Share.firstRenderShareNote = function(e, t, o) {
    $("#myShareNotebooks .folderHeader").trigger("click"),
      ...
      Share.changeNotebook(e, t, function(e) {
  ...
  (Share.changeNotebook = function(e, t, o) {
    ...
    0 == a.length
      ? (Notebook.selectNotebook(
          $(tt('#friendContainer_? a[notebookId="?"]', e, r.defaultNotebookId))
        ),
        (t = r.defaultNotebookId))
      : Notebook.selectNotebook(a),
    ...
    Share.isDefaultNotebookId(t) || (s.notebookId = t),
      ajaxGet(n, s, function(e) {
        s.notebookId,
          o
            ? o(e)
            : (Note.renderNotes(e, !1, !0),
              isEmpty(e) || Note.changeNoteForPjax(e[0].NoteId, !0, !1));
      });
  }),
  ...
  (Share.initContextmenu = function(e) {
    function t(e) {
      var t = $(this).attr("noteId"),
        o = Note.getNote(t),
        r = [];
      (Note.inBatch || !o) && r.push("delete"),
        !o ||
          (o.Perm && o.CreatedUserId == UserInfo.UserId) ||
          r.push("delete"),
        e.applyrule({ name: "target...", disable: !0, items: r });
    }
  ...
  $(function() {
    $("#noteItemList").on("click", ".item-shared .item-setting", function(e) {
      ...
      $("#leanoteDialogRemote").on("click", ".change-perm", function() {
        ...
        var s = "/share/updateShareNotebookPerm",
          i = { perm: n, toUserId: r };
        Share.dialogIsNote
          ? ((s = "/share/updateShareNotePerm"), (i.noteId = o))
          : (i.notebookId = o),
          ajaxGet(s, i, function(t) {
      ...
      $("#leanoteDialogRemote").on("click", ".delete-share", function() {
        var e = this,
          ...
          a = { toUserId: o };
        Share.dialogIsNote
          ? ((r = "/share/deleteShareNote"), (a.noteId = t))
          : (a.notebookId = t),
          ajaxGet(r, a, function(t) {
            t &&
              $(e)
                .parent()
                .parent()
    ...
    $("#leanoteDialogRemote").on("click", "#addShareNotebookBtn", function() {
      ...
      var t =
        '<tr id="tr' +
        e +
        '"><td>#</td><td><input id="friendsEmail" type="text" class="form-control" style="width: 200px" placeholder="' +
        getMsg("friendEmail") +
        '"/></td>';
      (t +=
        '<td><label for="readPerm' +
        e +
        '"><input type="radio" name="perm' +
        e +
        '" checked="checked" value="0" id="readPerm' +
        e +
        '"> ' +
        getMsg("readOnly") +
        "</label>"),
        (t +=
          ...
          '"><input type="radio" name="perm' +
          e +
          '" value="1" id="writePerm' +
          e +
          '"> ' +
          getMsg("writable") +
          "</label></td>"),
        (t +=
          '<td><button class="btn btn-success" onclick="addShareNoteOrNotebook(' +
          e +
          ')">' +
          getMsg("share") +
          "</button>"),
        (t +=
          ' <button class="btn btn-warning" onclick="deleteShareNoteOrNotebook(' +
          e +
          ')">' +
          getMsg("delete") +
          "</button>"),
